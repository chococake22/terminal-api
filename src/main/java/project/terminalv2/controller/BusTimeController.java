...
public class BusTimeController {
    ...
    public ResponseEntity getMyBusTimeList(@RequestParam Integer page, @RequestParam Integer size, HttpServletRequest tokenInfo) {
    ...
    public ResponseEntity saveMyBusTime(@PathVariable Long busTimeNo, HttpServletRequest tokenInfo) {
    ...
    public ResponseEntity deleteMyBusTime(@PathVariable Long myTimeNo, HttpServletRequest tokenInfo) {
